  ...
  useEffect(() => {
    async function getSchedule() {
      const resSchedule = await fetch(
        "https://prototype-masters-foofest.herokuapp.com/schedule"
      );
      ...
      <main>
        <section>
          ...
          <p className="schedule_text">
            This is the program for Foo Festival 2022. <br /> Please select
            which date you are interested in watching music.
          </p>
        </section>
